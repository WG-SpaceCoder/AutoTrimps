...
function initializeAutoTrimps() {
    ...
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://raw.githack.com/zininzinin/AutoTrimps/spin/NewUI.js')._;
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://raw.githack.com/zininzinin/AutoTrimps/spin/Graphs.js')._;
    toggleSettingsMenu();
    toggleSettingsMenu();
}
