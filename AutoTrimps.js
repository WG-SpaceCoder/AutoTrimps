    ...
    (function() {
        ...
        function manualLabor() {
            if (AutoManualLabor()) {
                if ((window.game.resources.trimps.owned - window.game.resources.trimps.employed) < 2 && window.canAffordBuilding('Trap') && window.game.global.buildingsQueue.length == 0) {
                ...
                if (window.game.buildings.Trap.owned > 0 && (window.game.resources.trimps.max - window.game.resources.trimps.owned) > 2 && window.game.upgrades.Trapstorm.done != 1) {
                    ...
                    if (window.game.upgrades.Trapstorm.done == 1) {
